...
fn main() -> miette::Result<()> {
    ...
    let dest_path = Path::new(&out_dir).join("src/precomputed/magic_constants.rs");
    ...
    .into_diagnostic()?;
    writeln!(f, "pub static BISHOP_SHIFTS: [u8; 64] = {bishop_shifts:?};").into_diagnostic()?;
    writeln!(
        f,
    ...
    println!("\nSuccessfully generated and wrote src/precomputed/magic_constants.rs");
    Ok(())
}
