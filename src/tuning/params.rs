...
// Pawn Structure
pub const ISOLATED_PENALTY: usize = 10;
pub const DOUBLED_PENALTY: usize = 11;
pub const BACKWARD_PENALTY: usize = 12;
pub const CONNECTED_BONUS: usize = 13;

// Passed Pawns (8 ranks)
pub const PASSED_PAWN_START: usize = 14; // 14..21

// Position Bonuses
pub const ROOK_OPEN_FILE_BONUS: usize = 22;
pub const ROOK_SEMI_FILE_BONUS: usize = 23;
pub const KNIGHT_OUTPOST_BONUS: usize = 24;

// PSTs (6 pieces * 64 squares = 384 params)
pub const PST_START: usize = 25;
